  ...
  return (
    <BannerWrapper className='d-flex align-items-center justify-content-start' style = {{
      ...
      <div className='banner-content w-100 container text-white'>
        <div className='banner-badge uppercase'>join streaming</div>
        <h1 className='banner-title uppercase'>best online game to play</h1>
        <p className='max-w-screen-sm text-2xl font-normal'>Live gaming with lots of other games. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
